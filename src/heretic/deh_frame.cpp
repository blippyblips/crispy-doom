...
typedef struct
{
    ...
    void (*func)(mobj_t* , struct player_t *, struct pspdef_t *);
...
static boolean GetActionPointerForOffset(int offset, void (**result)(mobj_t* , struct player_t *, struct pspdef_t *))
{
    int i;
