...
void P_LoadACScripts(int lump)
{
    ...
    ACSInfo = static_cast<acsInfo_t*>(Z_Malloc(ACScriptCount * sizeof(acsInfo_t), PU_LEVEL, 0));
    ...
    ACStrings = static_cast<char**>(Z_Malloc(ACStringCount * sizeof(char *), PU_LEVEL, NULL));
...
static void StartOpenACS(int number, int infoIndex, int offset)
{
    ...
    script = static_cast<acs_t*>(Z_Malloc(sizeof(acs_t), PU_LEVSPEC, 0));
