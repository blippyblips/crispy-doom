...
{  
    ...
    channels = static_cast<channel_t*>(I_Realloc(NULL, snd_channels*sizeof(channel_t)));
    sobjs = static_cast<degenmobj_t*>(I_Realloc(NULL, snd_channels*sizeof(degenmobj_t))); // [crispy] sound objects
...
void S_UpdateSndChannels (int choice)
{
    ...
    sobjs = static_cast<degenmobj_t*>(I_Realloc(sobjs, snd_channels * sizeof(degenmobj_t))); // [crispy] sound objects
