...
void F_Drawer (void)
{
    ...
    case F_STAGE_TEXT:
        ...
        {
            patch_t *slide = static_cast<patch_t*>(W_CacheLumpName(slideshow_panel, PU_CACHE));
    ...
    case F_STAGE_ARTSCREEN:
        ...
        {
            // draw credits
            patch_t *credits = static_cast<patch_t*>(W_CacheLumpName(DEH_String("CREDIT"), PU_CACHE));
