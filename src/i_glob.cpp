                         ...
                         const char *glob, ...)
{
    ...
    for (;;)
    {
        ...
        new_globs = static_cast<char**>(realloc(globs, sizeof(char *) * (num_globs + 1)));
        if (new_globs == NULL)
        {
...
static void ReadAllFilenames(glob_t *glob)
{
    ...
    for (;;)
    {
        ...
        glob->filenames = static_cast<char**>(realloc(glob->filenames, (glob->filenames_len + 1) * sizeof(char *)));
