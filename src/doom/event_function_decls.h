...
extern void A_Lower(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_Raise(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_Punch(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_ReFire(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FirePistol(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_Light1(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FireShotgun(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_Light2(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FireShotgun2(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_CheckReload(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_OpenShotgun2(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_LoadShotgun2(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_CloseShotgun2(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FireCGun(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_GunFlash(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FireMissile(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_Saw(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FirePlasma(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_BFGsound(mobj_t *mo, player_t *player, pspdef_t *psp);
extern void A_FireBFG(mobj_t *mo, player_t *player, pspdef_t *psp);
...
extern void A_FireOldBFG(mobj_t *mo, player_t *player, pspdef_t *psp);
