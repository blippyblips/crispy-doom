...
{
  statenum_t state = static_cast<statenum_t>(value);
    ...
    {
        weaponinfo[0].upstate = state;
    }
    else if (!strcasecmp(varname, "Next frame")) 
    {
        weaponinfo[0].downstate = state;
    }
    else if (!strcasecmp(varname, "Unknown 1"))
    {
        weaponinfo[0].readystate = state;
    }
    else if (!strcasecmp(varname, "Unknown 2"))
    {
        weaponinfo[0].atkstate = state;
    }
    else
    {
