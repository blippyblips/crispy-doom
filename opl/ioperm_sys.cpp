...
static SC_HANDLE (WINAPI *MyOpenSCManagerA)(const char *lpMachineName,
                                            const char *lpDatabaseName,
                                            DWORD dwDesiredAccess) = NULL;
static SC_HANDLE (WINAPI *MyCreateServiceA)(SC_HANDLE hSCManager,
...
static SC_HANDLE (WINAPI *MyOpenServiceA)(SC_HANDLE hSCManager,
                                          const char *lpServiceName,
                                          DWORD dwDesiredAccess);
static BOOL (WINAPI *MyStartServiceA)(SC_HANDLE hService,
...
static struct
{
    ...
    { "OpenSCManagerA",     (void **) &MyOpenSCManagerA },
    { "CreateServiceA",     (void **) &MyCreateServiceA },
    { "OpenServiceA",       (void **) &MyOpenServiceA },
    { "StartServiceA",      (void **) &MyStartServiceA },
...
int IOperm_EnablePortRange(unsigned int from, unsigned int num, int turn_on)
{
    ...
    h = CreateFileA(IOPERM_FILE, GENERIC_READ, 0, NULL,
...
int IOperm_InstallDriver(void)
{
    ...
    scm = MyOpenSCManagerA(NULL, NULL, SC_MANAGER_ALL_ACCESS);
    ...
    GetFullPathNameA("ioperm.sys", MAX_PATH, driver_path, NULL);

    // Create the service.

    svc = MyCreateServiceA(scm,
                           "ioperm",
                           "ioperm support for Cygwin driver",
                           SERVICE_ALL_ACCESS,
    ...
    if (svc == NULL)
    {
        ...
        {
            svc = MyOpenServiceA(scm, "ioperm", SERVICE_ALL_ACCESS);
