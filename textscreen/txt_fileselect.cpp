...
char *TXT_SelectFile(const char *window_title, const char **extensions)
{
    ...
    argv[0] = _strdup(ZENITY_BINARY);
    argv[1] = _strdup("--file-selection");
    argc = 2;
                                      ...
                                      const char *prompt, const char **extensions)
{
    ...
    fileselect = new txt_fileselect_t();
